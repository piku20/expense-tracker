...
import com.expense_tracker.feature.home.TransactionList
...
fun LineChart(entries: List<Entry>){
    ...
    AndroidView(
        ...
        val dataSet = LineDataSet(entries, "Expenses").apply{
            ...
            valueTextSize = 12f
            valueTextColor = parseColor("#FF2F7E79")

            val drawable = ContextCompat.getDrawable(
                context,
                R.drawable.char_gradient
            )
